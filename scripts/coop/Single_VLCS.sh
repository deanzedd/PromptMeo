...
# bash scripts/coop/single_VLCS.sh VLCS vit_b16_ep50_ctxv1 
# bash scripts/coop/Single_PACS.sh PACS vit_b16_ep50_ctxv1 
...
do
    ...
    do
        ...
        for SEED in  1 
        do
            DIR=output/base/${DATASET}/shots_${SHOTS}/${TRAINER}/${CFG}/seed${SEED}/Single_domain/${DOMAIN}
            if [ -d "$DIR" ]; then
