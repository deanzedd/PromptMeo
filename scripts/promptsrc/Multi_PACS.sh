...
# bash scripts/promptsrc/Multi_PACS.sh PACS vit_b16_c2_ep20_batch4_4+4ctx_cross_datasets
...
do
    ...
    do
        ...
        for SEED in  1 
        do
            DIR=output/base/${DATASET}/${TRAINER}/shots_${SHOTS}/${CFG}/seed${SEED}/Multi_domain/${DOMAIN}
            if [ -d "$DIR" ]; then
