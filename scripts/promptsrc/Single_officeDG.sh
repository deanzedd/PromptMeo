...
DATA="/mnt/disk1/theanh28/LAMM/DATA1/OH_DATASET"
TRAINER=PromptSRC
...
# bash scripts/promptsrc/Single_officeDG.sh OfficeHomeDG vit_b16_c2_ep20_batch4_4+4ctx_cross_datasets
